...
class DokumanListesiPage extends StatefulWidget {
  @override
  _DokumanListesiPageState createState() => _DokumanListesiPageState();
}

class _DokumanListesiPageState extends State<DokumanListesiPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Döküman Listesi"),
      ),
      body: ListView(
        children: [
          DataTable(columns: [
            DataColumn(label: Text("Yayın Evi")),
            DataColumn(label: Text("Kitap")),
            DataColumn(label: Text("Durum")),
          ], rows: [
            DataRow(cells: [
              DataCell(Text("DNR")),
              DataCell(Text("Yazılıma Giriş")),
              DataCell(Icon(Icons.check_box_outline_blank)),
            ]),
            DataRow(cells: [
              DataCell(Text("Kitap Kurdu")),
              DataCell(Text("Osmanlı Tarihi")),
            ...
            DataRow(cells: [
              DataCell(Text("Fikirtepe")),
              DataCell(Text("Orta Dünya")),
              DataCell(Icon(Icons.check_box)),
            ]),
            DataRow(cells: [
              DataCell(Text("China")),
              DataCell(Text("Savaş Sanatı")),
              DataCell(Icon(Icons.check_box_outline_blank)),
            ]),
            DataRow(cells: [
              DataCell(Text("DNR")),
